...
// Cloudflare-specific (non-IANA) status codes
// @see https://developers.cloudflare.com/support/troubleshooting/http-status-codes/cloudflare-5xx-errors/
export const HTTP_520_WEB_SERVER_RETURNED_UNKNOWN_ERROR = 520;
export const HTTP_521_WEB_SERVER_IS_DOWN = 521;
export const HTTP_522_CONNECTION_TIMED_OUT = 522;
export const HTTP_523_ORIGIN_IS_UNREACHABLE = 523;
export const HTTP_524_A_TIMEOUT_OCCURRED = 524;
export const HTTP_525_SSL_HANDSHAKE_FAILED = 525;
export const HTTP_526_INVALID_SSL_CERTIFICATE = 526;
export const HTTP_527_RAILGUN_ERROR = 527;
export const HTTP_530_ORIGIN_DNS_ERROR = 530;
...
export const HTTP_STATUS_MAP: Record<number, string> = {
  ...
  [HTTP_520_WEB_SERVER_RETURNED_UNKNOWN_ERROR]: 'HTTP_520_WEB_SERVER_RETURNED_UNKNOWN_ERROR',
  [HTTP_521_WEB_SERVER_IS_DOWN]: 'HTTP_521_WEB_SERVER_IS_DOWN',
  [HTTP_522_CONNECTION_TIMED_OUT]: 'HTTP_522_CONNECTION_TIMED_OUT',
  [HTTP_523_ORIGIN_IS_UNREACHABLE]: 'HTTP_523_ORIGIN_IS_UNREACHABLE',
  [HTTP_524_A_TIMEOUT_OCCURRED]: 'HTTP_524_A_TIMEOUT_OCCURRED',
  [HTTP_525_SSL_HANDSHAKE_FAILED]: 'HTTP_525_SSL_HANDSHAKE_FAILED',
  [HTTP_526_INVALID_SSL_CERTIFICATE]: 'HTTP_526_INVALID_SSL_CERTIFICATE',
  [HTTP_527_RAILGUN_ERROR]: 'HTTP_527_RAILGUN_ERROR',
  [HTTP_530_ORIGIN_DNS_ERROR]: 'HTTP_530_ORIGIN_DNS_ERROR',
};
